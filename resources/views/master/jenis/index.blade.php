...
@section('breadcrumb')
    @parent
    <li>Jenis Pengembangan Kompetensi</li>
@endsection
...
@section('script')
    <script type="text/javascript">
        ...
        function addForm() {
            ...
            $('.modal-title').text('Tambah Jenis Pengembangan Kompetensi');
        }
        ...
        function editForm(id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $('#modal-form').modal('show');
                    $('.modal-title').text('Edit Jenis Pengembangan Kompetensi');
                    $('#id').val(data.id);
                    $('#kode').val(data.kode);
                    $('#jenis_pelatihan').val(data.jenis_pelatihan);
