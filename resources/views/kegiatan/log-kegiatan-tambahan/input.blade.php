        ...
        <div class="col-md-12">
            <div class="box box-primary">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">Input Kegiatan Tambahan</h3>
                    </div>
                    ...
                    <form class="form" method="POST" autocomplete="off" enctype="multipart/form-data" id="form-logkegiatan">
                        ...
                        {{-- Kegiatan --}}
                        <div class="form-group">
                            <label for="id_master_kegiatan_tambahan" class="control-label">Kegiatan Tambahan</label>
                                <select class="form-control select2" id="id_master_kegiatan_tambahan" name="id_master_kegiatan_tambahan"
                                    autofocus required
                                    >
                                    <option value="">-- Pilih Kegiatan Tambahan --</option>
                                    @foreach ($kegiatan_tambahan as $list)
                                        <option 
                                            id="kegiatan-{{$list->id_master_kegiatan_tambahan}}"
                                            value="{{ $list->id_master_kegiatan_tambahan }}" 
...
@section('script')
    <script type="text/javascript">
        ...
        $("#id_master_kegiatan_tambahan").change(function () {
        ...
        $(function() {
            ...
            $('#form-logkegiatan').validator().on('submit', function(e) {
                if (!e.isDefaultPrevented()) {
                    ...
                    url = "{{ route('log-kegiatan-tambahan.store') }}";
